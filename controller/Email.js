		...
		user.save()
			.then(() => {
				transporter.sendMail({
					...
					text: "Hello world?",
					html: `<a href='https://email-800cal.vercel.app/?id=${token}'" class="mt-4 px-6 py-3 text-sm bg-[#91218f] text-white rounded-xl font-bold" style="border-radius: 0.75rem;font-weight: 700;margin-top: 1rem;padding-left: 1.5rem;padding-right: 1.5rem;padding-top: 0.75rem;padding-bottom: 0.75rem;font-size: 0.875rem;line-height: 1.25rem;background-color: rgb(145 33 143);color: rgb(255 255 255);">Click here to reset
							   your password</a>`
				})
					.then(() => {
